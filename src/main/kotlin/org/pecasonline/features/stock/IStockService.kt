...
interface IStockService {
    ...
    fun findStockByItemId(id: Int): Page<Stock>
    fun finStockByItemCode(code: String, page: Int?=0, size: Int?=10): Page<Stock>
    ...
    fun createStock(cnpj: String, file: MultipartFile): List<Long>
}