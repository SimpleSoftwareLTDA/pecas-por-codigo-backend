...
data class CreateContactDTO(
    @field:NotNull(message = "O nome do vendedores é obrigatório")
    @field:NotBlank(message = "O nome do vendedores não pode ser vazio")
    ...
    @field:NotBlank(message = "O telefone de peças não pode ser vazio")
    @JsonAlias("fonePecas")
