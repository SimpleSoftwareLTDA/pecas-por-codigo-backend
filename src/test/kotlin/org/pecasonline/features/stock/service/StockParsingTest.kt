...
class StockParsingTest {
    ...
    private val stockService = StockService(mock(), mock(), mock(), mock(), mock(), mock(), mock())

    @Test
    fun `should detect scientific notation as invalid`() {
        val line = "7,90E+12\t10\t19.99\tDescription"
        val result = ReflectionTestUtils.invokeMethod<Any>(stockService, "parseStockLine", line)
